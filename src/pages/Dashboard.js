...
const Dashboard = () => {
  ...
  const [completedShifts, setCompletedShifts] = useState([
    { id: 1, date: '2024-10-10', time: '09:00-12:00', location: 'Coimbatore', task: 'Cinemasupport', rating: 0, comment: '' },
    { id: 2, date: '2024-10-12', time: '14:00-17:00', location: 'Pondy', task: 'Ushering Guests', rating: 0, comment: '' }
  ]);
